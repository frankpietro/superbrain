...
@register(Market.SHOTS_TOTAL)
class ShotsTotalBet(_ShotsTotalLike):
    market = Market.SHOTS_TOTAL
    stat_column = "shots"


@register(Market.SHOTS_ON_TARGET_TOTAL)
class ShotsOnTargetTotalBet(_ShotsTotalLike):
    market = Market.SHOTS_ON_TARGET_TOTAL
    stat_column = "shots_on_target"
